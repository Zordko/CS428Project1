...
public class WeatherApiv2: MonoBehaviour
{
    public GameObject weatherTextObject;
        // add your personal API key after APPID= and before &units=
       string url = "http://api.openweathermap.org/data/2.5/weather?lat=29.7633&lon=-95.3633&APPID=7eed0cbc8defee0a9e86987c35810cd4&units=imperial";
    ...
    // wait a couple seconds to start and then refresh every 900 seconds
       ...
       InvokeRepeating("GetDataFromWeb", 2f, 200f);
   }
